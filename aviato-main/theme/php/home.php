...
<head>
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" type="image/x-icon" href="../images/percha.png" />
		...
		<div class="row">
			<div class="col-md-4 col-xs-12 col-sm-4">
				<div class="contact-number">
					...
					<span>449-109-79-36</span>
				</div>
			</div>
			<div class="col-md-4 col-xs-12 col-sm-4">
				<!-- Site Logo -->
				<div class="logo text-center">
					<a href="../theme/php/home.html">
						<!-- replace logo here -->
						<svg width="135px" height="29px" viewBox="0 0 155 29" version="1.1" xmlns="http://www.w3.org/2000/svg"
							...
							<g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" font-size="40"
								...
								<g id="Group" transform="translate(-108.000000, -297.000000)" fill="#000000">
									<text id="AVIATO">
										<tspan x="108.94" y="325">TOGUs</tspan>
									</text>
								</g>
							</g>
						</svg>
			...
			<div class="col-md-4 col-xs-12 col-sm-4">
				...
				<ul class="top-menu text-right list-inline">
						...
						<div class="dropdown-menu cart-dropdown">
							...
							<div class="media">
								<a class="pull-left" href="#!">
									<img class="media-object" src="../images/96a5e66a-b255-4eec-b130-44037dc9b763.jfif" alt="image" />
								</a>
								<div class="media-body">
									<h4 class="media-heading"><a href="#!">Top</a></h4>
							...
							<div class="media">
								<a class="pull-left" href="#!">
									<img class="media-object" src="../images/t-shirt/Big X blue.jfif" alt="image" />
								</a>
								<div class="media-body">
									<h4 class="media-heading"><a href="#!">Bolsa</a></h4>
									<div class="cart-price">
										<span>1 x</span>
										<span>1250.00</span>
									</div>
							...
							<ul class="text-center cart-buttons">
								...
								<li><a href="checkout.php" class="btn btn-small btn-solid-border">Pagar</a></li>
							</ul>
						</div>
					...
					<li class="dropdown search dropdown-slide" >
						<a href="../usuarios.php"><img class="usuarios" src="../images/usuario.png" alt="usuario"></a>
					</li>
					...
					<li class="dropdown search dropdown-slide" >
					  ...
					  <button type="button" class="btn btn-main text-center" id="logout" onclick="salir()" >Salir</button>
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown dropdown-slide">
						<a href="#!" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="350"
							role="button" aria-haspopup="true" aria-expanded="false">Compra <span
							...
							<div class="row">
								...
								<div class="col-lg-6 col-md-6 mb-sm-3">
									<ul>
										...
										<li><a href="../shop-sidebar.php">Comprar con barra lateral</a></li>
					...
					<li class="dropdown full-width dropdown-slide">
						<a href="#!" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="350"
							role="button" aria-haspopup="true" aria-expanded="false">Paginas <span
								class="tf-ion-ios-arrow-down"></span></a>
						<div class="dropdown-menu">
							<div class="row">
								...
								<div class="col-sm-3 col-xs-12">
									<ul>
										...
										<li><a href="../about.php">Acerca de nostros</a></li>
									</ul>
								</div>
								...
								<div class="col-sm-3 col-xs-12">
									<ul>
										<li class="dropdown-header">Utilidad</li>
										<li role="separator" class="divider"></li>
										
										<li><a href="../forget-password.php">Contraseña olvidada</a></li>
									</ul>
								</div>
					...
					<li class="dropdown dropdown-slide">
						...
						<ul class="dropdown-menu">
							<li><a href="../blog-left-sidebar.php">Blog TOGUs</a></li>
						</ul>
					</li><!-- / Blog -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 text-right">
          <p data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".1">Productos</p>
          <h1 data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".5">The beauty of nature <br> is hidden in details.</h1>
          <a data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".8" class="btn" href="../shop.php">Compra ahora</a>
        </div>
      </div>
    </div>
  </div>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="category-box">
					<a href="#!">
						<img src="../images/Outfit inspo aesthetic.jfif" alt="" />
						<div class="content">
							<h3>Venta de ropa</h3>
							<p>Comprar ropa de nueva temporada</p>
						</div>
					</a>	
				</div>
				<div class="category-box">
					<a href="#!">
						<img src="../images/_Call Me Angel_ T-Shirt.jfif" alt="" />
						<div class="content">
			...
			<div class="col-md-6">
				<div class="category-box category-box-2">
					<a href="#!">
						<img src="../images/96a5e66a-b255-4eec-b130-44037dc9b763.jfif" alt="" />
						<div class="content">
							<h3>Joyería</h3>
		...
		<div class="row"> 
			...
			<div class="col-md-4">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="../producto3.php">Pantalón Recto</a></h4>
						<p class="price">$230</p>
					</div>
				</div>
			</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<p class="copyright-text">Copyright &copy;2022, Designed TOGUs; Developed by C.P.P.V </p>
			</div>
		</div>
	</div>
</footer>
